...
object Append {
  ...
  implicit def appendList[L1Car <: Expr, L1Cdr <: Expr, L2 <: Expr](implicit append_ : Append[L1Cdr, L2]): Append[ConsCell[L1Car, L1Cdr], L2] {
    type Out = ConsCell[L1Car, append_.Out]} = new Append[ConsCell[L1Car, L1Cdr], L2] {
